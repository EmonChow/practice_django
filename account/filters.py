...
class PaymentVoucherFilter(filters.FilterSet):
    ...
    sub_ledger = filters.NumberFilter(field_name="sub_ledger", lookup_expr='exact')
    ...
    class Meta:
        ...
        fields = ['ledger', 'sub_ledger', 'branch', 'invoice_no', 'date_after', 'date_before']
...
class ReceiptVoucherFilter(filters.FilterSet):
    ...
    branch = filters.NumberFilter(field_name="branch", lookup_expr='exact')
    invoice_no = filters.CharFilter(field_name="invoice_no", lookup_expr='icontains')
    date_after = filters.DateFilter(field_name='receipt_date', lookup_expr='gte')
    date_before = filters.DateFilter(field_name='receipt_date', lookup_expr='lte')
...
class SalesFilter(filters.FilterSet):
    ...
    date_before = filters.DateFilter(field_name='sales_date', lookup_expr='lte')

    class Meta:
        model = Sales
        fields = ['sub_ledger', 'branch', 'invoice_no', 'date_after', 'date_before']
...
class PurchaseFilter(filters.FilterSet):
    ...
    branch = filters.NumberFilter(field_name="branch", lookup_expr='exact')
    invoice_no = filters.CharFilter(field_name="invoice_no", lookup_expr='icontains')
    date_after = filters.DateFilter(field_name='purchase_date', lookup_expr='gte')
    date_before = filters.DateFilter(field_name='purchase_date', lookup_expr='lte')
...
class AccountLogFilter(filters.FilterSet):
    reference_no = filters.CharFilter(field_name="reference_no", lookup_expr='exact')
...
class AccountLogFilterForDateAndSubLedgerOnly(filters.FilterSet):
    sub_ledger = filters.NumberFilter(field_name='sub_ledger__id', lookup_expr='exact')
    date_after = filters.DateFilter(field_name='log_date__date', lookup_expr='gte')
    date_before = filters.DateFilter(field_name='log_date__date', lookup_expr='lte')
