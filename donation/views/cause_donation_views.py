...
def createCauseDonation(request):
	...
	ref_invoice_no = Sales.objects.get(ledger__reference_id=cause_id).invoice_no
	...
	ReceiptVoucher.objects.create(ledger=cash_ledger, invoice_no=invoice, ref_invoice_no=ref_invoice_no, debit_amount=amount, receipt_date=current_datetime)
	ReceiptVoucher.objects.create(ledger=user_ledger, invoice_no=invoice, ref_invoice_no=ref_invoice_no, credit_amount=amount, receipt_date=current_datetime)
