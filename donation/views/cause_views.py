...
from donation.models import Cause, CauseContent
...
def createCause(request):
	...
	if serializer.is_valid():
		...
		cause_ledger = LedgerAccount.objects.create(name=name, reference_id=id, head_group=group_obj, ledger_type='cause_ledger')

		goal_amount = Decimal(filtered_data['goal_amount'])
		...
		Sales.objects.create(ledger=cause_ledger, sub_ledger=cause_subledger, invoice_no=invoice, debit_amount=goal_amount, sales_date=str_current_datetime)
		Sales.objects.create(ledger=company_sales_ledger, sub_ledger=cause_subledger, invoice_no=invoice, credit_amount=goal_amount, sales_date=str_current_datetime)
		AccountLog.objects.create(ledger=cause_ledger, sub_ledger=cause_subledger, reference_no=invoice, log_type='sales', debit_amount=goal_amount, log_date=str_current_datetime)
		AccountLog.objects.create(ledger=company_sales_ledger, sub_ledger=cause_subledger, reference_no=invoice, log_type='sales', credit_amount=goal_amount, log_date=str_current_datetime)
